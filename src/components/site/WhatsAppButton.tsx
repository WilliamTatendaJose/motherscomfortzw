...
export function WhatsAppButton({ number }: { number: string }) {
  ...
  return (
    <a
      ...
      className="fixed right-4 bottom-4 z-40 flex items-center gap-2 rounded-full bg-[#128C7E] px-4 py-3 text-white shadow-lift transition-transform hover:scale-105 md:right-6 md:bottom-6"
    >
